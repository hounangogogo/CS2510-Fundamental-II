...
// Examples
public class Examples implements FrogConstant {
    // Examples of frogs
    Frog frog1 = new Frog(new CartPt(width / 2, height - 25));
    Frog frog2 = new Frog(new CartPt(width / 2, 0));
    Frog frog3 = new Frog(new CartPt(width / 2, height - 53 * 2));

    // Examples of Floaters
    Floater lily1 = new LilyPad(new CartPt(width / 2, height - 53 * 2), 1);
    Floater log1 = new Log(new CartPt(width / 2, height - 53 * 2), 1);

    // Examples of FrogKillers
    FrogKiller zombie1 = new Zombie(
            new CartPt(width / 2, height - 53 * 2), 1);
    FrogKiller schoolbus1 = new SchoolBus(
            new CartPt(width / 2, height - 53 * 2), 1);
    FrogKiller firetruck1 = new FireTruck(
            new CartPt(width / 2, height - 53 * 2), 1);
    FrogKiller tank1 = new Tank(
            new CartPt(width / 2, height - 25), 1);
    FrogKiller tank2 = new Tank(
            new CartPt(width / 2, height - 25), -1);
    ...
    void testFrog(Tester t) {
        Frog frog3a = new Frog(new CartPt(width / 2, height - 53 * 2));
        Frog frog4 = new Frog(new CartPt(width / 2, 50));
        frog3a.hopOn(lily1);

        t.checkExpect(frog1.getLoc(), new CartPt(width / 2, height - 25));
        t.checkExpect(frog1.isPasssed(), false);

        // no change of location because frog1 is not on floater
        t.checkExpect(frog1.moveOn(), new CartPt(width / 2, height - 25));
        ...
        t.checkExpect(frog4.moveBy(-5000, 0), new CartPt(width / 2, 50));
        t.checkExpect(frog3a.moveBy(-5, 0), new CartPt(width / 2 - 5,
                height - 53 * 2));

    }

    void testFoaters(Tester t) {
        Frog frog3a = new Frog(new CartPt(width / 2, 53 * 2));
        Floater lily2 = new LilyPad(new CartPt(width / 2, 53 * 2), 1);
        Playground world1a = new Playground(frog3a, 0, 3);
        world1a.floaters.add(lily2);
        Frog frog3b = new Frog(new CartPt(width / 2, 53 * 2));

        // check if lily pad catches frog, and if frog realize it is 
        // on lily pad, and hopOn method 
        ...
        t.checkExpect(frog3b.floater, null);
        frog3b.hopOn(lily2);
        t.checkExpect(frog3b.floater, lily2);

    }

    void testVehicle(Tester t) {
        FrogKiller tank3 = new Tank(new CartPt(width / 2, height - 25), -1);
        t.checkExpect(tank3.moveOn(), new CartPt(width / 2 - 1, height - 25));
    }
    ...
    void testMakeImages(Tester t) {
        ...
        t.checkExpect(log1.makeImage(), new FromFileImage(log1.getLoc(),
                "log.png"));
        t.checkExpect(zombie1.makeImage(), new FromFileImage(zombie1.loc,
                "zombie_left.png"));
        t.checkExpect(schoolbus1.makeImage(), new FromFileImage(schoolbus1.loc,
                "schoolbus_left.png"));
        t.checkExpect(firetruck1.makeImage(), new FromFileImage(firetruck1.loc,
                "firetruck_right.png"));
        t.checkExpect(tank1.makeImage(), new FromFileImage(tank1.loc,
                "Tank_right.png"));
        t.checkExpect(tank2.makeImage(), new FromFileImage(tank2.loc,
                "Tank_left.png"));
    ...
    void testWorlds(Tester t) {
        ...
        Frog frog2a = new Frog(new CartPt(width / 2, 0));
        Frog frog4a = new Frog(new CartPt(0, height - 50 - 25 - 5));
        Frog frog4b = new Frog(new CartPt(width / 2, 53 * 2));
        ...
        t.checkExpect(frog2a.getLoc(), new CartPt(width / 2, 505));
        world1a.onKeyEvent("left");
        t.checkExpect(frog2a.getLoc(), new CartPt(width / 2 - 50, 505));
        world1a.onKeyEvent("right");
        t.checkExpect(frog2a.getLoc(), new CartPt(width / 2, 505));
        world1a.onKeyEvent("down");
        t.checkExpect(frog2a.getLoc(), new CartPt(width / 2, 505 + 53));
